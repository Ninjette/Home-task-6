...
/***/ function(module, exports) {
	...
	function serviceFunc($http) {
		...
		this.getJSON = function (callback, arg) {
			$http.get("http://www.omdbapi.com/?s=" + arg).then(callback);
		};

		this.getPageJSON = function (callback, arg, page) {
			$http.get("http://www.omdbapi.com/?s=" + arg + "&page=" + page).then(callback);
		};

		this.getItemJSON = function (callback, arg) {
			$http.get("http://www.omdbapi.com/?t=" + arg).then(callback);
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".c-rating{display:-webkit-box;display:-ms-flexbox;display:flex;list-style:none;margin:0;padding:0}.c-rating__item{-webkit-box-flex:0;-ms-flex:0 0 24px;flex:0 0 24px;height:24px;background:url(" + __webpack_require__(8) + ");cursor:pointer}.c-rating__item.is-active,.c-rating__item:hover{background-position:-24px 0}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "src/external/five-star-rating-master/img/stars.svg";
